# Naive Bayes
En este notebook se aplica el modelo probabilístico Naive Bayes, se ha utilizado la librería [naiveBayes](https://rpubs.com/maulikpatel/224581), así como el paquete [Caret](https://topepo.github.io/caret/) para calcular las métricas
