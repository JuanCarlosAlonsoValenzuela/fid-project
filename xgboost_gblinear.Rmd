...
search_grid <- expand.grid(
    ...
    feature_selector <- c("cyclic", "greedy")
)
...
system.time(
    logloss_error_hyperparameters <- apply(search_grid, 1, function(parameter_list) {
        ...
        current_updater <- parameter_list[["updater"]]
        current_feature_selector <- parameter_list[["feature_selector"]]
